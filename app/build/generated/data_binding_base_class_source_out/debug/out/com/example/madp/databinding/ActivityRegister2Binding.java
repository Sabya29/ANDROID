...
public final class ActivityRegister2Binding implements ViewBinding {
  ...
  private ActivityRegister2Binding(@NonNull ConstraintLayout rootView, @NonNull Button button3,
  ...
  public static ActivityRegister2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRegister2Binding((ConstraintLayout) rootView, button3,
